...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Build the SQL query
    $sql = "INSERT INTO `ACK_OUT`(`po_id`, `po_amount`, `po_message`, `po_datetime`, `ob_id`, `oa_id`, `ob_code`, `ob_datetime`, `cb_code`, `cb_datetime`, `bb_id`, `ba_id`, `bb_code`, `bb_datetime`) VALUES ('$po_id','$po_amount','$po_message','$po_datetime','$ob_id','$oa_id','$ob_code','$ob_datetime','$cb_code','$cb_datetime','$bb_id','$ba_id','$bb_code','$bb_datetime')";
